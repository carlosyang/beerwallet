...
beerwallet represents a major step forward in defcoin wallet security. It is
...
Unlike other iOS dogecoin wallets, beerwallet is a real dogecoin client. There
...
is possible because beerwallet is a 
...
beerwallet is open source and available under the terms of the MIT license.
Source code is available at https://github.com/mperklin/beerwallet
